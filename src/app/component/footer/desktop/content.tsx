    ...
    return (
        <footer ref={footerRef}>
            <div className="bg-[#F6F3EC] py-[60px]">
                <div className="relative  flex justify-between items-center w-[90%] max-w-[1200px] mx-auto">
                    <div className="w-[50%] mr-[30px]">
                        ...
                        <a className="block w-fit bg-[#F5C76F] rounded-[5px] px-[34px] py-[14px]" href="mailto:janyu427130@gmail.com" target="_blank">與我聯繫</a>
                    </div>
                    <div className="w-[40%] max-w-[320px]">
